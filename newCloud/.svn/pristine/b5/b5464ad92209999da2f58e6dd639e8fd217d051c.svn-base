...
//		System.out.println(BigDecimalUtil.multiply(new BigDecimal("0.00411"), new BigDecimal(0.7d)));
		
		Integer b=null;
		System.out.println(BigDecimalUtil.multiply(new BigDecimal("0.00411"), 0.71d));
