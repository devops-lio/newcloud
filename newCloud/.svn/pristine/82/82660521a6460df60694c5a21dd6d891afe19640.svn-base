	...
	<div class="content operation">
		...
		<div class="annular">
			...
			<div class="both">
				...
				<div>新增注册转换率   <p class="float">该指标值越高表示覆盖场所用户对网络速度表示满意，反之表示网络体验较差需要提高网络体验。</p></div>
			</div>
			<div class="both">
				<p class="round">0%</p>
				<canvas id='register' width='200' height='200'></canvas>
				<div>新增付费转换率<p class="float">该值越高表示用户对您无线网络的稳定性、网速及价格的高度认可，反之则表示您需优化网络稳定性、及提升网速，也有可能是该场所有竞争对手存在，请视情况酌情处理。</p></div>
			</div>
		</div>
