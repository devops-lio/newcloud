...
<div class="navbar navbar-inverse">
	<div class="navbar-inner">
		...
		<a class="brand" href="${ctx}/manage/index"><img
			src="${curPath}/img/logo.png" /></a>

		<ul class="nav pull-right">
<!-- 			<li class="hidden-phone"><input class="search" type="text" /></li> -->
			<li class="notification-dropdown hidden-phone">
				<a href="#"	class="trigger"> 欢迎您，
			...
			<!-- 								user registration <span class="time"><i class="icon-time"></i> -->
			<!-- 									13 min.</span> -->
			...
			<%-- 								src="${curPath}/style/img/contact-img.png" class="display" /> --%>
			...
			<%-- 								src="${curPath}/style/img/contact-img2.png" class="display" /> --%>
			<!-- 								<div class="name">Alejandra Galván</div> -->
			<!-- 								<div class="msg">There are many variations of available, -->
			...
			<!-- 			</a></li> -->
			<li class="settings hidden-phone"><a href="${ctx}/logOut"
