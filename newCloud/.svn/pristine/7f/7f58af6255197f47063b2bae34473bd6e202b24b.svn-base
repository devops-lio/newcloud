...
public class SendMailUtil {
	...
	private static String smtp="smtp.kdfwifi.com";
	private static String username="liuzhijiao@kdfwifi.com";
	private static String password="Jiaojiao810";
	private static String from = "liuzhijiao@kdfwifi.com";
	private static String[] to = {"rongxk@worldpollex.com"};
//	private static String[] copyto = {"songyanbiao@kdfwifi.com"};
	private static String[] copyto = {"gaoll@worldpollex.com","wanyuan@worldpollex.com","hanxiaocheng@kdfwifi.com"};
...
//				transport.sendMessage(mimeMsg, mimeMsg.getRecipients(Message.RecipientType.CC)); 
	...
	public static void main(String[] args){
		String smtp = "smtp.kdfwifi.com";
		String username="liuzhijiao@kdfwifi.com";
		String password="Jiaojiao810";
		String from = "liuzhijiao@kdfwifi.com";
		String[] to = {"songyanbiao@kdfwifi.com"};
		String[] copyto = {"wangying@kdfwifi.com","guoyingjie@kdfwifi.com","pengxianwei@kdfwifi.com"};
		String subject = "提现通知";
