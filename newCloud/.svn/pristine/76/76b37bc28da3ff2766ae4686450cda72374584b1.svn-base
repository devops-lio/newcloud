...
//    	if(last_time==null)last_time=
    ...
    public String toString() {
	    return "RouterInfoBean [mac=" + mac + ", authcount=" + authcount + ", install_position=" + install_position + ", ssid=" + ssid + ", startup_time=" + startup_time + ", version=" + version + ", homeurl=" + homeurl + ", auth_status=" + auth_status + ", authStatue=" + authStatue + ", interval_time=" + interval_time + ", last_time=" + last_time + ", statue=" + statue + ", userId=" + userId + ", userName=" + userName + "]";
    }
