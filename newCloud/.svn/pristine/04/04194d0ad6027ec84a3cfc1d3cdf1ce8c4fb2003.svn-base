...
$(function() {
	...
	// 保存按钮，click事件
	$(".doSaveGameCenterBtn").unbind("click");
	$(".doSaveGameCenterBtn").click(function() {
		$("#gameCenterForm").submit();
	});

	$("#defaultUrl").text(defaultSaleConfig.gameCenterUrl);
	if (saleConfig != null) {
		$("#url").val(saleConfig.gameCenterUrl);
		url = saleConfig.gameCenterUrl;
	}

});

$("#gameCenterForm").validate({
