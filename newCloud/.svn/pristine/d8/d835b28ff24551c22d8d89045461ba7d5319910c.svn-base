...
//		Map<String,String> businessData = new HashMap<String, String>();
		...
		sql.append(" SELECT ");
		sql.append(" sum(uv_num) uv_num,sum(register_num) register_num,sum(pay_num) pay_num,sum(login_num) login_num,");
		sql.append(" sum(permeate_ratenum) permeate_ratenum,sum(permeate_rateden) permeate_rateden,");
		sql.append(" sum(try_register_ratenum) try_register_ratenum,sum(try_register_rateden) try_register_rateden,");
		sql.append(" sum(register_pay_ratenum) register_pay_ratenum,sum(register_pay_rateden) register_pay_rateden");
